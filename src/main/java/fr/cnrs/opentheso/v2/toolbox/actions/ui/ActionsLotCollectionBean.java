...
public class ActionsLotCollectionBean implements Serializable {
    ...
    private final ActionsLotCollectionService collectionService;
    ...
    public void validateImport() {
        ...
        try {
            ActionsLotImportValidationResult<ActionsLotCollectionCandidate> result = collectionService.validate(
            ...
            if (!result.success()) {
                ...
                toast(result.validCount() + " rattachement(s) prêt(s) à importer");
            }
        } finally {
    ...
    public void applyImport() {
        ...
        importPanel.setBusy(true);
        try {
            ActionsLotApplyResult result = collectionService.applyImport(
