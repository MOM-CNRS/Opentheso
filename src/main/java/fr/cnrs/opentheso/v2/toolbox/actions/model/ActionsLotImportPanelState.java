...
public class ActionsLotImportPanelState<C> implements Serializable {
    ...
    private String searchType = "exactWord";
    ...
    private List<C> validCandidates = new ArrayList<>();
    ...
    public void applyValidation(ActionsLotImportValidationResult<C> result) {
        checked = true;
        done = false;
        if (!result.success()) {
