...
FROM hierarchical_relationship hr INNER JOIN concept c ON c.id_thesaurus = hr.id_thesaurus AND c.id_concept = hr.id_concept2 AND c.status != 'CA'
...
FROM hierarchical_relationship
         INNER JOIN concept ON concept.id_thesaurus = hierarchical_relationship.id_thesaurus
