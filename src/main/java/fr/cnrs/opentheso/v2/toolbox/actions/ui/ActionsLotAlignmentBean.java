...
public class ActionsLotAlignmentBean implements Serializable {
    ...
    private final ActionsLotAlignmentService alignmentService;
    ...
    public void validateImport() {
        ...
        try {
            ActionsLotValidationResult result = alignmentService.validateImport(
            ...
            if (!result.success()) {
                ...
                toast(result.validCount() + " ligne(s) prêtes à importer");
            }
        } finally {
    ...
    public void applyImport() {
        ...
        importPanel.setBusy(true);
        try {
            ActionsLotApplyResult result = alignmentService.applyImport(
    ...
    public void validateDelete() {
        ...
        try {
            ActionsLotValidationResult result = alignmentService.validateDelete(
            ...
            if (!result.success()) {
                ...
                String msg = result.validCount() + " ligne(s) prêtes à supprimer";
    ...
    public void applyDelete() {
        ...
        deletePanel.setBusy(true);
        try {
            ActionsLotApplyResult result = alignmentService.applyDelete(
