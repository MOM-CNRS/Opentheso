 ...
 */
public class ActionsLotNotePanelState implements Serializable {
    ...
    private List<ActionsLotNoteCandidate> validCandidates = new ArrayList<>();
    ...
    public List<ActionsLotNoteCandidate> getValidCandidates() {
