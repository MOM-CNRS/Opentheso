 ...
 */
public class ActionsLotAltLabelPanelState implements Serializable {
    ...
    private List<ActionsLotAltLabelCandidate> validCandidates = new ArrayList<>();
    ...
    public List<ActionsLotAltLabelCandidate> getValidCandidates() {
